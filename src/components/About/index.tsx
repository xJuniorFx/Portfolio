            ...
            <div className={classNames(styles.container , styles.about__container)}>
                <div className={styles.about__me}>
                    <div className={styles.about__me_image} >
                        <img className={styles.image} src={img} alt='foto-perfil'/>
                        <img className={styles.image__alternative} src={img2} alt='foto-perfil-2'/>
                    </div>
                </div>
                <div className={styles.about__content}>
                    <div className={styles.title}><h1>About <span>Me</span></h1></div>
                    <p>
                        ...
                        with technology only intensified, and I realized that my calling lies in becoming a Programmer.
                    </p>
                    <p>
                    ...
                    <p>
                        This portfolio is the record of my exhilarating adventure in the world of front-end 
                        development so far.
                    </p>
                    ...
                    <div className={styles.technologies}>   
                        ...
                        <img alt='Icon Java' src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/java/java-original.svg" />
                        <img alt='Icon HTML' src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/html5/html5-original.svg" />
