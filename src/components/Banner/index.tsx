                    ...
                    <div className={styles.left_content}>
                        ...
                        <div className={styles.content_destaque}>
                            <div className={styles.animated_text}>
                                <h2 className={styles.destaque}>Front-End Developer</h2>
                            </div>
                        ...
                        <div className={styles.resume}>
                            <p>
                                ...
                                skills. I thrive in team environments, valuing clear communication and transparency. 
                            </p>
                            <p>
                                With the ability to work independently, I ensure projects are completed even under tight deadlines. Explore
